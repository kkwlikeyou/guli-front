            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                ...
                <li
                  ...
                  :key="index"
                  @click="getSubSubjectList(item, index)"
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li
                  ...
                  :key="index"
                  @click="getCourseList(item, index)"
...
export default {
  ...
  methods: {
    initCourseFirst() {
      this.searchObj = {};
      this.oneIndex = -1;
      courseApi.getCourseList(this.page, 8, this.searchObj).then((resp) => {
    ...
    getSubSubjectList(subjectNested, index) {
      this.oneIndex = index;
      this.twoIndex = -1;
      this.searchObj.subjectId = "";
      this.subSubjectList = [];
      this.searchObj.subjectParentId = subjectNested.id;
      this.gotoPage(1);
      this.subSubjectList = subjectNested.children;
    },
    getCourseList(subSubject, index) {
      this.twoIndex = index;
      this.searchObj.subjectId = subSubject.id;
      this.gotoPage(1);
    },
    searchBuyCount() {
      this.buyCountSort = "1";
